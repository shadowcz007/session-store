/**
 * Vendored verbatim from cc-haha's src/utils/sessionTitleText.ts (41 LOC).
 *
 * Converts system-injected XML wrappers (slash command breadcrumbs) into
 * user-facing text. Pure regex, zero dependencies.
 */
